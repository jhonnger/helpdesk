...
## uno a la cantidad de intentos, si es menor a tres mato la sesión
...
## Verifico que la nueva contraseña no se haya utilizado en los últimos $_SESSION[PHD_DIAS_PSW] días
...
## Guardo la nueva contraseña en el histórico
...
## Finalmente, si corresponde, restauro el nivel de ejecución que tenía
